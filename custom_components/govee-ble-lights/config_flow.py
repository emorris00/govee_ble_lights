    ...
    async def async_step_bluetooth_confirm(self, user_input: dict[str, Any] | None = None) -> FlowResult:
        ...
        if user_input is not None:
            return self.async_create_entry(
                title=title, data={CONF_MODEL: user_input[CONF_MODEL], CONF_KEEP_ALIVE: user_input[CONF_KEEP_ALIVE]}
            )
    ...
    async def async_step_user(self, user_input: dict[str, Any] | None = None) -> FlowResult:
        ...
        if user_input is not None:
            ...
            return self.async_create_entry(
                ...
                data={CONF_MODEL: user_input[CONF_MODEL], CONF_KEEP_ALIVE: user_input[CONF_KEEP_ALIVE]},
            )
